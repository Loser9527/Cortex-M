...
void Fill_ST7789(uint16_t xstart, uint16_t ystart, uint16_t xend, uint16_t yend, uint16_t color)
{
	uint32_t num;
	Write_ST7789_Reg(0x2a);        //设置x坐标；
	Write_ST7789_Data(xstart>>8);
	Write_ST7789_Data(xstart&0xff); 
	Write_ST7789_Data(xend>>8);
	Write_ST7789_Data(xend&0xff); 
	Write_ST7789_Reg(0x2b);        //设置y坐标；
	Write_ST7789_Data(ystart>>8);
	Write_ST7789_Data(ystart&0xff);
	Write_ST7789_Data(yend>>8);
	Write_ST7789_Data(yend&0xff);
