...
#define 			ST7789_CS_SET								GPIO_SetBits(ST7789_CS_PORT, ST7789_CS_PIN)
#define				ST7789_CS_CLR									GPIO_ResetBits(ST7789_CS_PORT, ST7789_CS_PIN)
...
#define 			ST7789_WR_SET								GPIO_SetBits(ST7789_WR_PORT, ST7789_WR_PIN)
#define				ST7789_WR_CLR									GPIO_ResetBits(ST7789_WR_PORT, ST7789_WR_PIN)
...
#define 			ST7789_RD_SET								GPIO_SetBits(ST7789_RD_PORT, ST7789_RD_PIN)
#define				ST7789_RD_CLR									GPIO_ResetBits(ST7789_RD_PORT, ST7789_RD_PIN)
